...
public class FlightSearchTests {
    ...
    public void setUp() throws Exception {
        ...
        Plane plane2 = new Plane("type2", 5);
        ...
        Flight flight4 = new Flight("F003", source, destination, plane2);
    ...
    @Test
    public void shouldReturnListOfFlightsForMatchingSourceDestinationSeats() throws Exception {
        List<Flight> flights = allFlights.byLocation(source, destination,6).getFlightList();
        Assert.assertEquals(source, flights.get(0).getSource());
        Assert.assertEquals(destination, flights.get(0).getDestination());
        Assert.assertEquals(source, flights.get(1).getSource());
        Assert.assertEquals(destination, flights.get(1).getDestination());
